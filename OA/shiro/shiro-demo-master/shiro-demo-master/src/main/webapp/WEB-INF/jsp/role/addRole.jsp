...
<span>新增角色</span>
	...
	<div style="width:400px">
	    ...
	    <form onsubmit="return checkSubmit()" id="ff" method="post" action="${pageContext.request.contextPath }/role/doAddRole" >
	    	<table cellpadding="5" cellspacing="10">
	    		<tr>
	    			<td>角色名称:</td>
	    			<td><input type="text" name="role" required="required"></input></td>
	    		</tr>
	    		<tr>
	    			<td>角色描述:</td>
	    			<td><input type="text" name="description" required="description"></input></td>
	    		</tr>
	    		<tr>
	    			<td>角色权限:</td>
	    			<td>
