...
body, div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, form,
	fieldset, input, p, blockquote, table, th, td, embed, object, button {
	margin: 0;
	padding: 0;
	font-size: 12px;
	color: #343434;
...
a:focus, input[type="text"]:focus, input[type="password"]:focus,
	textarea:focus {
	outline: none;
}
...
<body>
	...
	<div class="yelangsembg">
		...
		<div class="wrap" style="margin-top: 85px;">
			<div class="w7">
				<span><img
					src="${pageContext.request.contextPath }/static/img/404.gif"></span> <span>
					<p>
					...
					<h2>您可以：</h2>
					<p>
						<a href="${pageContext.request.contextPath }/">返回首页</a><a href="#"
							onclick="returnHistory()">返回上一级</a>
					</p>
					<h3>
						本页面将在<em id="timeout">4</em>秒钟后自动转到首页，请稍后...
					</h3>
				</span>
			</div>
		</div>
